...
/**
 * Class MetaBoxesStackRunner
 */
class MetaBoxesStackRunner implements RunnerInterface
{
    /**
    ...
    {
        /**
         * @var $metaBoxStack MetaBoxesStack
         */
        $metaBoxStack = self::getContainer()->get(MetaBoxesStack::class);
        $metaBoxStack
            ->initialize()
            ->register();
    }
